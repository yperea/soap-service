...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements gov.noaa.NdfdXML {
 ...
 */
    ...
    public gov.noaa.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public gov.noaa.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.noaa.NdfdXMLBindingStub _stub = new gov.noaa.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.noaa.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.noaa.NdfdXMLBindingStub _stub = new gov.noaa.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
